...
import driverChatRoutes from './routes/driver-chat.routes.js';
import lovoxRoutes from './routes/lovox.routes.js';
import reservationRoutes from './routes/reservation.routes.js';
import quoteRoutes from './routes/quote.routes.js';
import stripeRoutes from './routes/stripe.routes.js';
import authRoutes from './routes/auth.routes.js';
import mayahuelRoutes from './routes/mayahuel.routes.js';
...
app.use('/api', driverChatRoutes);
app.use('/api', reservationRoutes);
app.use('/api', lovoxRoutes);
app.use('/api', quoteRoutes);
app.use('/api', stripeRoutes);
app.use('/api', authRoutes);
app.use('/api', mayahuelRoutes);
