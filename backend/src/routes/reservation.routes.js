...
router.post('/reservas/cancelar', async (req, res, next) => {
  try {
    ...
    res.type('html').send(`<!doctype html><html lang="es"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Reserva cancelada | LuxRides</title><style>body{margin:0;background:#f5f5f2;color:#18222f;font-family:Arial,sans-serif}.page{max-width:620px;margin:0 auto;padding:34px 20px 48px}.brand{color:#b8860b;font-size:13px;font-weight:700;letter-spacing:2px;text-align:center}.brand-line{width:42px;height:2px;background:#b8860b;margin:12px auto 26px}.card{background:#fff;border:1px solid #e6e2da;box-shadow:0 12px 32px rgba(24,34,47,.08);padding:30px;text-align:center}.icon{display:flex;align-items:center;justify-content:center;width:62px;height:62px;margin:0 auto 18px;border-radius:50%;background:#e9f8ef;color:#16803c;font-size:31px;font-weight:700}.eyebrow{margin:0 0 8px;color:#16803c;font-size:12px;font-weight:700;letter-spacing:1.2px}.title{margin:0;color:#17212d;font-size:30px;line-height:1.15}.copy{margin:14px auto 0;max-width:430px;color:#52606d;font-size:15px;line-height:1.55}.reservation{margin:26px 0 24px;padding:15px 16px;background:#faf8f3;border-left:3px solid #b8860b;text-align:left}.reservation-label{display:block;color:#6b7280;font-size:11px;font-weight:700;letter-spacing:1px}.reservation-id{display:block;margin-top:5px;color:#18222f;font-size:16px;font-weight:700;overflow-wrap:anywhere}.home{display:block;padding:13px 18px;background:#b8860b;color:#fff;font-size:15px;font-weight:700;text-decoration:none}.home:hover{background:#96700a}.footer{margin:22px 0 0;color:#77808a;font-size:12px;text-align:center}@media(max-width:480px){.page{padding:20px 14px 34px}.card{padding:25px 20px}.title{font-size:26px}}</style></head><body><main class="page"><div class="brand">LUXRIDES</div><div class="brand-line"></div><section class="card"><div class="icon">✓</div><p class="eyebrow">GESTION DE RESERVA</p><h1 class="title">Reserva cancelada</h1><p class="copy">Tu solicitud fue procesada correctamente. La reserva ya no aparece como un servicio activo.</p><div class="reservation"><span class="reservation-label">RESERVA CANCELADA</span><strong class="reservation-id">${reservaId}</strong></div><a class="home" href="${env.frontendOrigin}">Volver a reservar</a></section><p class="footer">LuxRides | Transporte ejecutivo</p></main></body></html>`);
  } catch (error) {
    next(error);
  }
});
